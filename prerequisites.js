let subjectObjects = []
        function Initialize(){
            ...
            /*
            buttonElements = document.getElementById('mainDiv')
            if (buttonElements.length > 0) {
                console.log('Button elements were added successfully.');
              } else {
                console.log('No button elements found in the parent element.');
              }
            */
            ...
            */
            ...
            console.log(999, prerequisites)
            Object.keys(prerequisites).forEach(key => {
                const buttonElement = document.getElementById(key)
                console.log(`adding -> ${buttonElement}, id: ${key}`)
